...
export default function FrostedGlassIcon({
  ...
  if (!isMounted) {
    // Renderiza un contenedor básico sin estilos de tema para evitar el mismatch
    return (
        <div className={`relative rounded-xl flex items-center justify-center ${sizeClasses[size]} ${className}`}>
