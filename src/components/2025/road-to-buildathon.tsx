...
const timelineEvents = [
  ...
  },
  {
    ...
    description: "Una Década de Ethereum: Bolivia Se Suma al Bloque",
    place: "UTEPSA",
    registrationLink: "https://app.unlock-protocol.com/event/una-dcada-de-ethereum-bolivia-se-suma-al-bloque-1",
    status: "upcoming",
